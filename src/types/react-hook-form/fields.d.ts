...
export declare type FieldName<TFieldValues extends FieldValues> =
...
export declare type FieldValue<TFieldValues extends FieldValues> =
  TFieldValues[InternalFieldName];

export declare type FieldValues = Record<string, any>;

export declare type NativeFieldValue =
  | string
  | number
  | boolean
  | null
...
export declare type FieldElement<
